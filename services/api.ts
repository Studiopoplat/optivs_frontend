import { User, Transaction, JWTTokenResponse, TwoFactorRequiredResponse, KycStatusResponse, WithdrawalRequest, KycRequest, AdminStats, DashboardStats, TeamMember, Generate2FAResponse } from './types';
...
export const adminProcessKyc = (id: string, action: 'approve' | 'reject', reason?: string): Promise<{ success: boolean }> => {
